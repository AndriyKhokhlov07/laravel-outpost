<?php include '../layouts/header.php' ?>
    ...
    <div class="main_width main_page">
        <div class="oc_info_block">
            <h1 class="top_title">Easy Move-In. Easy Living. Find your next home.</h1>
            <ul class="main_menu">
                <li class="button_li"><a class="main_butt" href="#apply_now">Apply for free</a></li>
            </ul>
            <p class="top_paragraph">Convenient locations, beautifully designed spaces and hassle-free application.All-inclusive options available.</p>
        </div>
        ...
        <div class="oc_block rooms">
            <div class="fx w ch2">
                <div class="room">
                    <a class="img" href="">
<!--                        <div class="new">New</div>-->
                        <img class="lazy" src="/pictures/main/room1.jpg" alt="Easy move-in. Easy living. Find your next home.  (Image-1)">
                    </a>
                    <a class="h2" href="">The Clark House</a>
                    <div class="annotation">Harlem, Manhattan
                        <p>Private rooms from <span>$1450</span></p>
                    </div>
                </div>
                <div class="room">
                    <a class="img" href="">
<!--                        <div class="new">New</div>-->
                        <img class="lazy" src="/pictures/main/room2.jpg" alt="Easy move-in. Easy living. Find your next home.  (Image-1)">
                    </a>
                    <a class="h2" href="">The Gramercy Park Studios</a>
                    <div class="annotation">Harlem, Manhattan
                        <p>Private rooms from <span>$1250</span></p>
                    </div>
                </div>
                <div class="room">
                    <a class="img" href="">
<!--                        <div class="new">New</div>-->
                        <img class="lazy" src="/pictures/main/room3.jpg" alt="Easy move-in. Easy living. Find your next home.  (Image-1)">
                    </a>
                    <a class="h2" href="">The Maison Jefferson</a>
                    <div class="annotation">Harlem, Manhattan
                        <p>Private rooms from <span>$1550</span></p>
                    </div>
                </div>
                <div class="room">
                    <a class="img" href="">
<!--                        <div class="new">New</div>-->
                        <img class="lazy" src="/pictures/main/room4.jpg" alt="Easy move-in. Easy living. Find your next home.  (Image-1)">
                    </a>
                    <a class="h2" href="">The Cornelia House</a>
                    <div class="annotation">Harlem, Manhattan
                        <p>Private rooms from <span>$1350</span></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="oc_block">
            <div class="content_width">
                ...
                <div class="oc_paragraphs">
                    <p>People of many different cultures, backgrounds and areas of expertise.
                        Many of our former Coliving isn’t just about having
        ...
        <div class="oc_block">
            <hr class="hr">
            <img class="oc_img" src="/pictures/pages/room.jpg" alt="Coliving">
            <div class="content_width">
                <div class="oc_titles">
        ...
        <div class="oc_block how_it_works">
            <hr class="hr">
            <div class="content_width">
                <div class="oc_titles">
                    ...
                    <div class="items_experience">
                        <div class="content_row title">
                            ...
                            <div class="id_label">
                                ...
                                <label class="item_plus" for="con_1"></label>
                            </div>
                            <p class="text">Decide if you want housing <span>for a month or two</span> or are looking
                        ...
                        <div class="content_row">
                            ...
                            <div class="id_label">
                                <label class="item first" for="con_2">2</label>
                                <label class="item_plus" for="con_2"></label>
                            </div>
                        ...
                        <div class="content_row">
                            ...
                            <div class="id_label">
                                <label class="item first" for="con_3">3</label>
                                <label class="item_plus" for="con_3"></label>
                            </div>
                        ...
                        <div class="content_row">
                            ...
                            <div class="id_label">
                                <label class="item first" for="con_4">4</label>
                                <label class="item_plus" for="con_4"></label>
                            </div>
                        ...
                        <div class="content_row">
                            ...
                            <div class="id_label">
                                <label class="item first" for="con_5">5</label>
                                <label class="item_plus" for="con_5"></label>
                            </div>
            ...
            <div class="content_bottom">
                <div class="circle_block">
                    ...
                    <div class="bounce_text">
                        ...
                        <div>
                            <p class="item_text">Outpost Club is a propertymanagement technology platform
                ...
                <div class="right_text apply">
                    <a href="" class="button3 red" data-text="Apply for free"></a>
                </div>
            </div>
        </div>
        <div class="oc_block comfort">
            <hr class="hr">
            ...
            <div class="content_houses">
                <div class="items_experience">
                    <div class="content_row">
                        ...
                        <div class="text img"><img class="oc_img" src="/pictures/main/comfort.jpg" alt="Comfort"></div>
                    ...
                    <div class="content_row">
                        ...
                        <div class="text img"><img class="oc_img" src="/pictures/main/community.jpg" alt="Coliving"></div>
                    ...
                    <div class="content_row">
                        ...
                        <div class="text img"><img class="oc_img" src="/pictures/main/convenience.jpg" alt="Coliving"></div>
...
<!--                        <p class="item_text">It's no secret that New York City is one of the most expensive places you can live—it ranks as number one among U.S. cities year after year, and is consistently within the top 10 most expensive places to live worldwide. And while that might deter some eager wanderers from making the Big Apple home, there are plenty of ways you can save money and still experience all New York has to offer.</p>-->
        ...
        <div class="main_width center find_us">
            <hr class="hr">
            <p class="first_title">Find us on...</p>
