...
<div class="main_width terms_of_use">

    <div class="oc_info_block">
        <h1 class="top_title">These Terms of Use are a legal agreement</h1>
        <p class="top_paragraph">Please read agreement these terms of use carefully because they contain important
            information regarding your rights and obligations.</p>
    </div>
    ...
    <div class="oc_block">
        ...
        <div class="content_width">
            <div class="oc_titles">
                <h3 class="first_title">These Terms<br> of Use</h3>
                <p class="text_title">Last Updated December 1, 2020</p>
            </div>
            <div class="oc_paragraphs">
                <p>These Terms of Use are a legal agreement between you and Outpost Club. Outpost Club is an online
                    co-living leasing platform and provider of Outpost Club Coliving services belonging to the Outpost
                    Club Inc. As such it provides fully furnished residential apartments rented out on a room basis in
                    prime locations in various cities across the United States of America, Canada and Europe. Along this
                    document, Outpost Club refers to either Outpost Club Inc or Outpost Club Canada Inc, depending on
                    the location of the room you desire to rent. For renting a room in Canada, Outpost Club will stand
                    for Outpost Club Canada Inc, while for renting a room in the USA, Outpost Club will stand for
                    Outpost Club Inc.</p>
                <br>
                <p>Via the Platform’s website https://www.outpost-club.com, the user can request rent one of currently
                    available rooms in a fast and easy manner. By leasing through the platform operated by Outpost Club,
                    you enter into a direct (legally binding) contractual relationship with Outpost Club with which you
                    step into a Lease agreement.</p>
                <br>
                <p><strong>THE SERVICES PROVIDED BY OUTPOST CLUB BELONGING TO THE OUTPOST CLUB INC, INCLUDE BUT ARE NOT
                        LIMITED TO:</strong></p>
                <br>
                <ol>
                ...
                <br>
                <p>If a first month rent payment in form of monthly monetary payments applies to tenants of the Outpost
                    Club Community, Outpost Club may provide additional services or features as portrayed on its website
                    https://www.outpost-club.com. Outpost Club Inc waives responsibility to claims to the maximum extent
                    permitted by law. If you do not agree to the Terms of Use, you are not permitted to obtain information
                    from the website or to continue to use this information in any other manner.</p>
                <br>
                <p>Independent of your registration, you declare with the use of this website that you have read,
                    understood and accepted the following Terms of Use. Furthermore, you give your assurance that you
                    will comply with the Terms of Use.</p>
            </div>
        </div>
    </div>
    ...
    <div class="slide1 main_width">
        ...
        <div class="text_block1 content_width">
            <div class="text_left">
                    <p class="text2">These Terms<br> of Use</p>
                    <p class="text3_2">Last Updated December 1, 2020</p>
                </div>
            <div class="text_right">
                ...
                <p><strong>THE SERVICES PROVIDED BY OUTPOST CLUB BELONGING TO THE OUTPOST CLUB INC, INCLUDE BUT ARE NOT LIMITED TO:</strong>
                    <ol>
                        <li>contact person for rent enquiry (tenant support);</li>
                        <li>receiving complaints and dispute resolution;</li>
                        <li>management of receivables (e. g. first month rent payment collection and the assertion of all claims to which the principal is entitled as well as dunning legal actions under consultation of experienced lawyers);</li>
    ...
    <div class="slide3 main_width">
        <div class="main_width">
            <hr class="hr1">
            <div class="text_block1 content_width">
                <div class="text_left">
                    <p class="text2">Eligibility</p>
                </div>
                <div class="text_right">
                    ...
                    <ul>
                        ...
                        <li itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div class="faq_text" itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                                ...
                                <p>There is no right to registration, leasing, or to tenancy in our provided rooms. Registration and leasing are at the discretion of Outpost Club Inc. You furthermore accept that a signed lease is a pre-condition to tenancy.</p>
    ...
    <div class="slide3">
        <div class="main_width">
            ...
            <div class="text_block1 content_width">
                <div class="text_left">
                    <p class="text2">Leasing a Room</p>
    ...
    <div class="slide3">
        <div class="main_width">
            ...
            <div class="text_block1 content_width">
                <div class="text_left">
                    <p class="text2">Payment<br> Conditions</p>
